...
W_conv1 = read_file("W_conv1.txt")
b_conv1 = read_file("b_conv1.txt")

h1_conv = tf.nn.relu(conv2d(x_image, W_conv1) + b_conv1)
h1_pool = max_pool_2x2(h1_conv)

W_conv2 = read_file("W_conv2.txt")
b_conv2 = read_file("b_conv2.txt")
...
W_fc1 = read_file("W_fc1.txt")
b_fc1 = read_file("b_fc1.txt")
...
W_fc2 = read_file("W_fc2.txt")
b_fc2 = read_file("b_fc2.txt")
